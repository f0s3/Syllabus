let {NNIOrFacultyController} = require('./NNIOrFacultyController');
let {GroupOrSubgroupController} = require('./GroupOrSubgroupController');
let {DateController} = require('./DateController');

let TableController = function () {
    console.log('TableController activated');
    let db = NNIOrFacultyController;
    let tableName = GroupOrSubgroupController;
    let tableColumns = DateController;
    console.log(tableName);
    //get data from db and fill the table

/*
fetch(GroupOrSubgroupController())
